...
const FetchLinkedNews = ({ setLinkedNews }) => {
    useEffect(() => {
...
const FetchPopularNews = ({ setPopularNews }) => {
    useEffect(() => {
...
const NewsPage = () => {
    ...
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <FetchLinkedNews setLinkedNews={setLinkedNews} />
            <FetchPopularNews setPopularNews={setPopularNews} />
